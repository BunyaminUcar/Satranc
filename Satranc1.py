...
y=[i for i in At if all([ 0<i[0]<9 , 0<i[1]<9 ])]
...
y1=[i for i in fil if all([ 0<i[0]<9 , 0<i[1]<9 ])]
...
y2=[i for i in sah if all([ 0<i[0]<9 , 0<i[1]<9 ])]
...
y3=[i for i in kale if all([ 0<i[0]<9 , 0<i[1]<9 ])]
print("Kale  :",y3)
...
y4=[i for i in vezir if all([ 0<i[0]<9 , 0<i[1]<9 ])]
